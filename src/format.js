...
export const HELP_TEXT = [
  ...
  'Photo — send a picture (several angles at once = one meal, more accurate)',
  '',
  'For better numbers: put a hand, fork or plate in frame for scale, and send',
  'the picture as a FILE rather than a photo to keep full resolution.',
  '',
  ...
  '/reference — save your hand/plate sizes so portions are judged against them',
